...
FUENTEFLECHA = ("Calibri bold", 17)  # FLECHA DE REGRESO
FUENTE21 = ("Bahnschrift SemiBold", 12)  # DNI/EDAD PACIENTE GRABADO
FUENTE13 = ("Bahnschrift SemiBold", 13)  # TITULOS CON FONDO AZUL
FUENTE16 = ("Bahnschrift SemiBold", 15)  # TITULO BOTONOS
FUENTE14 = ("Bahnschrift Light", 8)  # FORMATO (dd/mm/aaa) (g/cm^2)
FUENTEPIE = ("Bahnschrift Light", 10)  # PIE DE PAGINA
FUENTE1 = ("Bahnschrift Light", 11)  # TODOS LOS CUESTIONARIOS
FUENTE11 = ("Bahnschrift Light", 13)  # RESULTADOS Y RECOMENDACIONES
FUENTE17 = ("Bahnschrift Light", 17)  # INGRESE SU CONTRASEÑA
FUENTE25 = ("Bahnschrift Light", 19)  # RAMAS
FUENTE35 = ("Bahnschrift Light", 25)  # BUSCADOR DNI
FUENTE36 = ("Bahnschrift Light", 40)  # TITULO INICIO
...
class ActualizarRegistroNuevo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        lumbar_dmo = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=30, column=4, sticky="nsew")
        lumbar_tscore = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=30, column=5, sticky="nsew")
        lumbar_zcore = tk.Entry(self, font=FUENTE1, background="WHITE", fg="black", width=1, justify="center").grid(
            row=30, column=6, sticky="nsew")

        # INGRESO DE DATOS CUELLO --------------------------------------------------------------------------------------

        cuello_dmo = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=31, column=4, sticky="nsew")
        cuello_tscore = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=31, column=5, sticky="nsew")
        cuello_zcore = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=31, column=6, sticky="nsew")

        # INGRESO DE TROCANTER --------------------------------------------------------------------------------------

        trocanter_dmo = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=32, column=4, sticky="nsew")
        trocanter_tscore = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=32, column=5, sticky="nsew")
        trocanter_zcore = tk.Entry(self, font=FUENTE1, background="white", fg="black", width=1, justify="center").grid(
            row=32, column=6, sticky="nsew")
...
class MostradorResultados(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="  RESULTADOS DEL 20/05/2013", font=FUENTE13, background="#5b9fc9", anchor="w",
        ...
        lumbar_dmo = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                              justify="center").grid(
            row=30, column=3, sticky="nsew")
        lumbar_tscore = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                 justify="center").grid(
            row=30, column=4, sticky="nsew")
        lumbar_zcore = tk.Label(self, text="1", font=FUENTE1, background="WHITE", fg="black", width=1,
                                justify="center").grid(
            row=30, column=5, sticky="nsew")

        # INGRESO DE DATOS CUELLO --------------------------------------------------------------------------------------

        cuello_dmo = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                              justify="center").grid(
            row=31, column=3, sticky="nsew")
        cuello_tscore = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                 justify="center").grid(
            row=31, column=4, sticky="nsew")
        cuello_zcore = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                justify="center").grid(
            row=31, column=5, sticky="nsew")

        # INGRESO DE TROCANTER --------------------------------------------------------------------------------------

        trocanter_dmo = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                 justify="center").grid(
            row=32, column=3, sticky="nsew")
        trocanter_tscore = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                    justify="center").grid(
            row=32, column=4, sticky="nsew")
        trocanter_zcore = tk.Label(self, text="1", font=FUENTE1, background="white", fg="black", width=1,
                                   justify="center").grid(
            row=32, column=5, sticky="nsew")
...
class HistoriaPacienteAntiguo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label4 = tk.Label(self, text="Edad: ", font=FUENTE21, anchor="e", bg="white").grid(row=8, column=3,
                                                                                           sticky="nsew")
        nacimientoNuevoPaciente = tk.Label(self, text="60 años", font=FUENTE1, bg="white", width=1).grid(row=8,
                                                                                                         column=4,
                                                                                                         sticky="nsew")
        ...
        tabla4 = tk.Label(self, text="DMO (CUELLO F.)", font=FUENTE1, anchor="center", background="#e0e0e0").grid(
            row=20, column=4, sticky="nsew")
        tabla5 = tk.Label(self, text="IMC", font=FUENTE1, anchor="center", background="#e0e0e0").grid(
        ...
        estadoVariable1 = tk.Label(self, text="Osteoporosis Grave", font=FUENTE1, bg="white", width=1, relief="solid",
                                   borderwidth=1)
        estadoVariable1.grid(row=21, column=2, sticky="nsew")

        dmolumbarVariable = tk.Label(self, text="-2.12", font=FUENTE1, bg="white", width=1, relief="solid",
                                     borderwidth=1)
        dmolumbarVariable.grid(row=21, column=3, sticky="nsew")

        dmocuelloVariable = tk.Label(self, text="-2.32", font=FUENTE1, bg="white", width=1, relief="solid",
                                     borderwidth=1)
        dmocuelloVariable.grid(row=21, column=4, sticky="nsew")

        imcVariable = tk.Label(self, text="18.7", font=FUENTE1, bg="white", width=1, relief="solid",
                               borderwidth=1)
        imcVariable.grid(row=21, column=5, sticky="nsew")
